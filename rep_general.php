                ...
                <div class="select mb-2" style="width: 100%;">
                    <select name="status" style="width: 100%;">
                        ...
                        <?php
                            ...
                            $fConsultaEstado = mysql_query($sqlConsultaEstado);
        
                            while ($rConsultaEstado = mysql_fetch_array($fConsultaEstado)) {
                                $isSelected = "";
            ...
            <tbody>
                <?php
                    while($r = mysql_fetch_array($data)) {
                        ...
                        $dataEstado = mysql_query($sqlEstado, $cn);
                        $rEstado = mysql_fetch_array($dataEstado);
